...
AbstractCompiler compiler;
   ...
   */
  void tryMinimizeExits_7au3e(Node n, int exitType, String labelName) {
...
void tryMinimizeExits(Node n, int exitType, String labelName) {
	Object o_7au3e = null;
	String c_7au3e = "com.google.javascript.jscomp.MinimizeExitPoints";
	String msig_7au3e = "tryMinimizeExits(Node$int$String)"
			+ eid_tryMinimizeExits_Node_int_String_7au3e;
	try {
		tryMinimizeExits_7au3e(n, exitType, labelName);
		FieldPrinter.print(this, eid_tryMinimizeExits_Node_int_String_7au3e,
				c_7au3e, msig_7au3e, 1, 5);
		FieldPrinter.print(n, eid_tryMinimizeExits_Node_int_String_7au3e,
				c_7au3e, msig_7au3e, 2, 5);
	} catch (Throwable t7au3e) {
		FieldPrinter.print(t7au3e, eid_tryMinimizeExits_Node_int_String_7au3e,
