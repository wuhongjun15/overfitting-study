...
final class NameAnalyzer implements CompilerPass {
  ...
  public static int eid_AliasSet_AliasSet_String_String_7au3e = 0;

	public static int eid_ReferencePropagationCallback_traverseEdge_JsName_RefType_JsName_7au3e = 0;

	public static int eid_JsName_toString_7au3e = 0;

	public static int eid_JsName_compareTo_JsName_7au3e = 0;

	public static int eid_RefNode_name_7au3e = 0;

	public static int eid_RefNode_remove_7au3e = 0;

	public static int eid_JsNameRefNode_JsNameRefNode_JsName_Node_7au3e = 0;

	public static int eid_JsNameRefNode_name_7au3e = 0;

	public static int eid_JsNameRefNode_remove_7au3e = 0;

	public static int eid_PrototypeSetNode_PrototypeSetNode_JsName_Node_7au3e = 0;

	public static int eid_PrototypeSetNode_remove_7au3e = 0;

	public static int eid_SpecialReferenceNode_SpecialReferenceNode_JsName_Node_Node_Node_7au3e = 0;

	public static int eid_SpecialReferenceNode_name_7au3e = 0;

	public static int eid_ClassDefiningFunctionNode_ClassDefiningFunctionNode_JsName_Node_Node_Node_7au3e = 0;

	public static int eid_ClassDefiningFunctionNode_remove_7au3e = 0;

	public static int eid_InstanceOfCheckNode_InstanceOfCheckNode_JsName_Node_Node_Node_7au3e = 0;

	public static int eid_InstanceOfCheckNode_remove_7au3e = 0;

	public static int eid_ProcessExternals_visit_NodeTraversal_Node_Node_7au3e = 0;

	public static int eid_FindDependencyScopes_visit_NodeTraversal_Node_Node_7au3e = 0;

	public static int eid_FindDependencyScopes_recordDepScope_Node_NameInformation_7au3e = 0;

	public static int eid_HoistVariableAndFunctionDeclarations_visit_NodeTraversal_Node_Node_7au3e = 0;

	public static int eid_FindDeclarationsAndSetters_visit_NodeTraversal_Node_Node_7au3e = 0;

	public static int eid_FindDeclarationsAndSetters_recordSet_String_Node_7au3e = 0;

	public static int eid_FindDeclarationsAndSetters_recordPrototypeSet_String_String_Node_7au3e = 0;

	public static int eid_FindDeclarationsAndSetters_recordWriteOnProperties_String_7au3e = 0;

	public static int eid_FindReferences_FindReferences_7au3e = 0;

	public static int eid_FindReferences_addAllChildren_Node_7au3e = 0;

	public static int eid_FindReferences_addSimplifiedChildren_Node_7au3e = 0;

	public static int eid_FindReferences_addSimplifiedExpression_Node_Node_7au3e = 0;

	public static int eid_FindReferences_shouldTraverse_NodeTraversal_Node_Node_7au3e = 0;

	public static int eid_FindReferences_visit_NodeTraversal_Node_Node_7au3e = 0;

	public static int eid_FindReferences_maybeHiddenAlias_String_Node_7au3e = 0;

	public static int eid_FindReferences_maybeRecordAlias_String_Node_NameInformation_String_7au3e = 0;

	public static int eid_FindReferences_NodeAccumulator_classDefiningCallsHaveSideEffects_7au3e = 0;

	public static int eid_FindReferences_NodeAccumulator_keepSubTree_Node_7au3e = 0;

	public static int eid_FindReferences_NodeAccumulator_keepSimplifiedShortCircuitExpression_Node_7au3e = 0;

	public static int eid_FindReferences_NodeAccumulator_keepSimplifiedHookExpression_Node_boolean_boolean_7au3e = 0;

	public static int eid_RemoveListener_nodeRemoved_Node_7au3e = 0;
	...
	public static void clearORefMap() {
		oref_map.clear();
		eid_AliasSet_AliasSet_String_String_7au3e = 0;
		eid_ReferencePropagationCallback_traverseEdge_JsName_RefType_JsName_7au3e = 0;
		eid_JsName_toString_7au3e = 0;
		eid_JsName_compareTo_JsName_7au3e = 0;
		eid_RefNode_name_7au3e = 0;
		eid_RefNode_remove_7au3e = 0;
		eid_JsNameRefNode_JsNameRefNode_JsName_Node_7au3e = 0;
		eid_JsNameRefNode_name_7au3e = 0;
		eid_JsNameRefNode_remove_7au3e = 0;
		eid_PrototypeSetNode_PrototypeSetNode_JsName_Node_7au3e = 0;
		eid_PrototypeSetNode_remove_7au3e = 0;
		eid_SpecialReferenceNode_SpecialReferenceNode_JsName_Node_Node_Node_7au3e = 0;
		eid_SpecialReferenceNode_name_7au3e = 0;
		eid_ClassDefiningFunctionNode_ClassDefiningFunctionNode_JsName_Node_Node_Node_7au3e = 0;
		eid_ClassDefiningFunctionNode_remove_7au3e = 0;
		eid_InstanceOfCheckNode_InstanceOfCheckNode_JsName_Node_Node_Node_7au3e = 0;
		eid_InstanceOfCheckNode_remove_7au3e = 0;
		eid_ProcessExternals_visit_NodeTraversal_Node_Node_7au3e = 0;
		eid_FindDependencyScopes_visit_NodeTraversal_Node_Node_7au3e = 0;
		eid_FindDependencyScopes_recordDepScope_Node_NameInformation_7au3e = 0;
		eid_HoistVariableAndFunctionDeclarations_visit_NodeTraversal_Node_Node_7au3e = 0;
		eid_FindDeclarationsAndSetters_visit_NodeTraversal_Node_Node_7au3e = 0;
		eid_FindDeclarationsAndSetters_recordSet_String_Node_7au3e = 0;
		eid_FindDeclarationsAndSetters_recordPrototypeSet_String_String_Node_7au3e = 0;
		eid_FindDeclarationsAndSetters_recordWriteOnProperties_String_7au3e = 0;
		eid_FindReferences_FindReferences_7au3e = 0;
		eid_FindReferences_addAllChildren_Node_7au3e = 0;
		eid_FindReferences_addSimplifiedChildren_Node_7au3e = 0;
		eid_FindReferences_addSimplifiedExpression_Node_Node_7au3e = 0;
		eid_FindReferences_shouldTraverse_NodeTraversal_Node_Node_7au3e = 0;
		eid_FindReferences_visit_NodeTraversal_Node_Node_7au3e = 0;
		eid_FindReferences_maybeHiddenAlias_String_Node_7au3e = 0;
		eid_FindReferences_maybeRecordAlias_String_Node_NameInformation_String_7au3e = 0;
		eid_FindReferences_NodeAccumulator_classDefiningCallsHaveSideEffects_7au3e = 0;
		eid_FindReferences_NodeAccumulator_keepSubTree_Node_7au3e = 0;
		eid_FindReferences_NodeAccumulator_keepSimplifiedShortCircuitExpression_Node_7au3e = 0;
		eid_FindReferences_NodeAccumulator_keepSimplifiedHookExpression_Node_boolean_boolean_7au3e = 0;
		eid_RemoveListener_nodeRemoved_Node_7au3e = 0;
...
/** Reference to the JS compiler */
  ...
  private class FindDeclarationsAndSetters extends AbstractPostOrderCallback {
    ...
    public void visit_7au3e(NodeTraversal t, Node n, Node parent) {
	...
	public void visit(NodeTraversal t, Node n, Node parent) {
		Object o_7au3e = null;
		String c_7au3e = "com.google.javascript.jscomp.NameAnalyzer";
		String msig_7au3e = "visit(NodeTraversal$Node$Node)"
				+ eid_FindDeclarationsAndSetters_visit_NodeTraversal_Node_Node_7au3e;
		try {
			visit_7au3e(t, n, parent);
			addToORefMap(msig_7au3e, null);
			addToORefMap(msig_7au3e, this);
			addToORefMap(msig_7au3e, t);
			addToORefMap(msig_7au3e, n);
			addToORefMap(msig_7au3e, parent);
