...
class ProcessClosurePrimitives extends AbstractPostOrderCallback
  ...
  public static int eid_ProcessClosurePrimitives_AbstractCompiler_CheckLevel_boolean_7au3e = 0;

	public static int eid_getExportedVariableNames_7au3e = 0;

	public static int eid_process_Node_Node_7au3e = 0;

	public static int eid_visit_NodeTraversal_Node_Node_7au3e = 0;

	public static int eid_processRequireCall_NodeTraversal_Node_Node_7au3e = 0;

	public static int eid_processProvideCall_NodeTraversal_Node_Node_7au3e = 0;

	public static int eid_handleCandidateProvideDefinition_NodeTraversal_Node_Node_7au3e = 0;

	public static int eid_processBaseClassCall_NodeTraversal_Node_7au3e = 0;

	public static int eid_getEnclosingDeclNameNode_NodeTraversal_7au3e = 0;

	public static int eid_reportBadBaseClassUse_NodeTraversal_Node_String_7au3e = 0;

	public static int eid_processProvideFromPreviousPass_NodeTraversal_String_Node_7au3e = 0;

	public static int eid_processSetCssNameMapping_NodeTraversal_Node_Node_7au3e = 0;

	public static int eid_trySimplifyNewDate_NodeTraversal_Node_Node_7au3e = 0;

	public static int eid_verifyProvide_NodeTraversal_Node_Node_7au3e = 0;

	public static int eid_verifyArgument_NodeTraversal_Node_Node_7au3e = 0;

	public static int eid_verifyArgument_NodeTraversal_Node_Node_int_7au3e = 0;

	public static int eid_registerAnyProvidedPrefixes_String_Node_JSModule_7au3e = 0;

	public static int eid_ProvidedName_ProvidedName_String_Node_JSModule_boolean_7au3e = 0;

	public static int eid_ProvidedName_addProvide_Node_JSModule_boolean_7au3e = 0;

	public static int eid_ProvidedName_isExplicitlyProvided_7au3e = 0;

	public static int eid_ProvidedName_addDefinition_Node_JSModule_7au3e = 0;

	public static int eid_ProvidedName_updateMinimumModule_JSModule_7au3e = 0;

	public static int eid_ProvidedName_replace_7au3e = 0;

	public static int eid_ProvidedName_createDeclarationNode_7au3e = 0;

	public static int eid_ProvidedName_makeVarDeclNode_String_Node_7au3e = 0;

	public static int eid_ProvidedName_createNamespaceLiteral_7au3e = 0;

	public static int eid_ProvidedName_makeAssignmentExprNode_String_Node_7au3e = 0;

	public static int eid_isNamespacePlaceholder_Node_7au3e = 0;

	public static int eid_UnrecognizedRequire_UnrecognizedRequire_Node_String_String_7au3e = 0;

	public static void clearORefMap() {
		eid_ProcessClosurePrimitives_AbstractCompiler_CheckLevel_boolean_7au3e = 0;
		eid_getExportedVariableNames_7au3e = 0;
		eid_process_Node_Node_7au3e = 0;
		eid_visit_NodeTraversal_Node_Node_7au3e = 0;
		eid_processRequireCall_NodeTraversal_Node_Node_7au3e = 0;
		eid_processProvideCall_NodeTraversal_Node_Node_7au3e = 0;
		eid_handleCandidateProvideDefinition_NodeTraversal_Node_Node_7au3e = 0;
		eid_processBaseClassCall_NodeTraversal_Node_7au3e = 0;
		eid_getEnclosingDeclNameNode_NodeTraversal_7au3e = 0;
		eid_reportBadBaseClassUse_NodeTraversal_Node_String_7au3e = 0;
		eid_processProvideFromPreviousPass_NodeTraversal_String_Node_7au3e = 0;
		eid_processSetCssNameMapping_NodeTraversal_Node_Node_7au3e = 0;
		eid_trySimplifyNewDate_NodeTraversal_Node_Node_7au3e = 0;
		eid_verifyProvide_NodeTraversal_Node_Node_7au3e = 0;
		eid_verifyArgument_NodeTraversal_Node_Node_7au3e = 0;
		eid_verifyArgument_NodeTraversal_Node_Node_int_7au3e = 0;
		eid_registerAnyProvidedPrefixes_String_Node_JSModule_7au3e = 0;
		eid_ProvidedName_ProvidedName_String_Node_JSModule_boolean_7au3e = 0;
		eid_ProvidedName_addProvide_Node_JSModule_boolean_7au3e = 0;
		eid_ProvidedName_isExplicitlyProvided_7au3e = 0;
		eid_ProvidedName_addDefinition_Node_JSModule_7au3e = 0;
		eid_ProvidedName_updateMinimumModule_JSModule_7au3e = 0;
		eid_ProvidedName_replace_7au3e = 0;
		eid_ProvidedName_createDeclarationNode_7au3e = 0;
		eid_ProvidedName_makeVarDeclNode_String_Node_7au3e = 0;
		eid_ProvidedName_createNamespaceLiteral_7au3e = 0;
		eid_ProvidedName_makeAssignmentExprNode_String_Node_7au3e = 0;
		eid_isNamespacePlaceholder_Node_7au3e = 0;
		eid_UnrecognizedRequire_UnrecognizedRequire_Node_String_String_7au3e = 0;
	}
...
static final DiagnosticType NULL_ARGUMENT_ERROR = DiagnosticType.error(
  ...
  private class ProvidedName {
	...
	/**
	 * Replace the provide statement. If we're providing a name with no definition, then create one. If we're providing a name with a duplicate definition, then make sure that definition becomes a declaration.
	 */
	void replace() {
		Object o_7au3e = null;
		String c_7au3e = "com.google.javascript.jscomp.ProcessClosurePrimitives";
		String msig_7au3e = "replace()" + eid_ProvidedName_replace_7au3e;
		try {
			replace_7au3e();
			FieldPrinter.print(this, eid_ProvidedName_replace_7au3e, c_7au3e,
					msig_7au3e, 1, 5);
		} catch (Throwable t7au3e) {
			FieldPrinter.print(t7au3e, eid_ProvidedName_replace_7au3e, c_7au3e,
					msig_7au3e, 0, 5);
			throw t7au3e;
		} finally {
			eid_ProvidedName_replace_7au3e++;
		}
	}
  }
