...
final class ControlFlowAnalysis implements Callback, CompilerPass {
  ...
  public static int eid_ControlFlowAnalysis_AbstractCompiler_boolean_boolean_7au3e = 0;

	public static int eid_getCfg_7au3e = 0;

	public static int eid_process_Node_Node_7au3e = 0;

	public static int eid_prioritizeFromEntryNode_DiGraphNodeLTEMPNode_BranchRTEMP_7au3e = 0;

	public static int eid_shouldTraverse_NodeTraversal_Node_Node_7au3e = 0;

	public static int eid_visit_NodeTraversal_Node_Node_7au3e = 0;

	public static int eid_handleIf_Node_7au3e = 0;

	public static int eid_handleWhile_Node_7au3e = 0;

	public static int eid_handleDo_Node_7au3e = 0;

	public static int eid_handleFor_Node_7au3e = 0;

	public static int eid_handleSwitch_Node_7au3e = 0;

	public static int eid_handleCase_Node_7au3e = 0;

	public static int eid_handleDefault_Node_7au3e = 0;

	public static int eid_handleWith_Node_7au3e = 0;

	public static int eid_handleStmtList_Node_7au3e = 0;

	public static int eid_handleFunction_Node_7au3e = 0;

	public static int eid_handleExpr_Node_7au3e = 0;

	public static int eid_handleThrow_Node_7au3e = 0;

	public static int eid_handleTry_Node_7au3e = 0;

	public static int eid_handleCatch_Node_7au3e = 0;

	public static int eid_handleBreak_Node_7au3e = 0;

	public static int eid_handleContinue_Node_7au3e = 0;

	public static int eid_handleReturn_Node_7au3e = 0;

	public static int eid_handleStmt_Node_7au3e = 0;

	public static int eid_computeFollowNode_Node_ControlFlowAnalysis_7au3e = 0;

	public static int eid_computeFollowNode_Node_7au3e = 0;

	public static int eid_computeFollowNode_Node_Node_ControlFlowAnalysis_7au3e = 0;

	public static int eid_computeFallThrough_Node_7au3e = 0;

	public static int eid_createEdge_Node_ControlFlowGraph_Branch_Node_7au3e = 0;

	public static int eid_connectToPossibleExceptionHandler_Node_Node_7au3e = 0;

	public static int eid_getNextSiblingOfType_Node_int_7au3e = 0;

	public static int eid_isBreakTarget_Node_String_7au3e = 0;

	public static int eid_isContinueTarget_Node_Node_String_7au3e = 0;

	public static int eid_matchLabel_Node_String_7au3e = 0;

	public static int eid_mayThrowException_Node_7au3e = 0;

	public static int eid_isBreakStructure_Node_boolean_7au3e = 0;

	public static int eid_isContinueStructure_Node_7au3e = 0;

	public static int eid_getExceptionHandler_Node_7au3e = 0;

	public static int eid_getCatchHandlerForBlock_Node_7au3e = 0;

	public static int eid_AstControlFlowGraph_AstControlFlowGraph_Node_MapLTEMPDiGraphNodeLTEMPNode_BranchRTEMP_IntegerRTEMP_boolean_7au3e = 0;

	public static int eid_AstControlFlowGraph_getOptionalNodeComparator_boolean_7au3e = 0;

	public static int eid_AstControlFlowGraph_getPosition_DiGraphNodeLTEMPNode_BranchRTEMP_7au3e = 0;

	public static void clearORefMap() {
		eid_ControlFlowAnalysis_AbstractCompiler_boolean_boolean_7au3e = 0;
		eid_getCfg_7au3e = 0;
		eid_process_Node_Node_7au3e = 0;
		eid_prioritizeFromEntryNode_DiGraphNodeLTEMPNode_BranchRTEMP_7au3e = 0;
		eid_shouldTraverse_NodeTraversal_Node_Node_7au3e = 0;
		eid_visit_NodeTraversal_Node_Node_7au3e = 0;
		eid_handleIf_Node_7au3e = 0;
		eid_handleWhile_Node_7au3e = 0;
		eid_handleDo_Node_7au3e = 0;
		eid_handleFor_Node_7au3e = 0;
		eid_handleSwitch_Node_7au3e = 0;
		eid_handleCase_Node_7au3e = 0;
		eid_handleDefault_Node_7au3e = 0;
		eid_handleWith_Node_7au3e = 0;
		eid_handleStmtList_Node_7au3e = 0;
		eid_handleFunction_Node_7au3e = 0;
		eid_handleExpr_Node_7au3e = 0;
		eid_handleThrow_Node_7au3e = 0;
		eid_handleTry_Node_7au3e = 0;
		eid_handleCatch_Node_7au3e = 0;
		eid_handleBreak_Node_7au3e = 0;
		eid_handleContinue_Node_7au3e = 0;
		eid_handleReturn_Node_7au3e = 0;
		eid_handleStmt_Node_7au3e = 0;
		eid_computeFollowNode_Node_ControlFlowAnalysis_7au3e = 0;
		eid_computeFollowNode_Node_7au3e = 0;
		eid_computeFollowNode_Node_Node_ControlFlowAnalysis_7au3e = 0;
		eid_computeFallThrough_Node_7au3e = 0;
		eid_createEdge_Node_ControlFlowGraph_Branch_Node_7au3e = 0;
		eid_connectToPossibleExceptionHandler_Node_Node_7au3e = 0;
		eid_getNextSiblingOfType_Node_int_7au3e = 0;
		eid_isBreakTarget_Node_String_7au3e = 0;
		eid_isContinueTarget_Node_Node_String_7au3e = 0;
		eid_matchLabel_Node_String_7au3e = 0;
		eid_mayThrowException_Node_7au3e = 0;
		eid_isBreakStructure_Node_boolean_7au3e = 0;
		eid_isContinueStructure_Node_7au3e = 0;
		eid_getExceptionHandler_Node_7au3e = 0;
		eid_getCatchHandlerForBlock_Node_7au3e = 0;
		eid_AstControlFlowGraph_AstControlFlowGraph_Node_MapLTEMPDiGraphNodeLTEMPNode_BranchRTEMP_IntegerRTEMP_boolean_7au3e = 0;
		eid_AstControlFlowGraph_getOptionalNodeComparator_boolean_7au3e = 0;
		eid_AstControlFlowGraph_getPosition_DiGraphNodeLTEMPNode_BranchRTEMP_7au3e = 0;
	}
