 ...
 */
class CodeGenerator {
  public static int eid_CodeGenerator_CodeConsumer_7au3e = 0;
	public static int eid_forCostEstimation_CodeConsumer_7au3e = 0;
	public static int eid_CodeGenerator_CodeConsumer_CompilerOptions_7au3e = 0;
	public static int eid_tagAsStrict_7au3e = 0;
	public static int eid_add_String_7au3e = 0;
	public static int eid_addIdentifier_String_7au3e = 0;
	public static int eid_add_Node_7au3e = 0;
	public static int eid_add_Node_Context_7au3e = 0;
	public static int eid_unrollBinaryOperator_Node_int_String_Context_Context_int_int_7au3e = 0;
	public static int eid_isSimpleNumber_String_7au3e = 0;
	public static int eid_getSimpleNumber_String_7au3e = 0;
	public static int eid_isIndirectEval_Node_7au3e = 0;
	public static int eid_addNonEmptyStatement_Node_Context_boolean_7au3e = 0;
	public static int eid_isOneExactlyFunctionOrDo_Node_7au3e = 0;
	public static int eid_addExpr_Node_int_Context_7au3e = 0;
	public static int eid_addList_Node_7au3e = 0;
	public static int eid_addList_Node_boolean_7au3e = 0;
	public static int eid_addList_Node_boolean_Context_7au3e = 0;
	public static int eid_addArrayList_Node_7au3e = 0;
	public static int eid_addCaseBody_Node_7au3e = 0;
	public static int eid_addAllSiblings_Node_7au3e = 0;
	public static int eid_addJsString_Node_7au3e = 0;
	public static int eid_jsString_String_boolean_7au3e = 0;
	public static int eid_regexpEscape_String_CharsetEncoder_7au3e = 0;
	public static int eid_escapeToDoubleQuotedJsString_String_7au3e = 0;
	public static int eid_regexpEscape_String_7au3e = 0;
	public static int eid_strEscape_String_char_String_String_String_CharsetEncoder_boolean_boolean_7au3e = 0;
	public static int eid_identifierEscape_String_7au3e = 0;
	public static int eid_getNonEmptyChildCount_Node_int_7au3e = 0;
	public static int eid_getFirstNonEmptyChild_Node_7au3e = 0;
	public static int eid_getContextForNonEmptyExpression_Context_7au3e = 0;
	public static int eid_getContextForNoInOperator_Context_7au3e = 0;
	public static int eid_appendHexJavaScriptRepresentation_StringBuilder_char_7au3e = 0;
	public static int eid_appendHexJavaScriptRepresentation_int_Appendable_7au3e = 0;

	public static void clearORefMap() {
		eid_CodeGenerator_CodeConsumer_7au3e = 0;
		eid_forCostEstimation_CodeConsumer_7au3e = 0;
		eid_CodeGenerator_CodeConsumer_CompilerOptions_7au3e = 0;
		eid_tagAsStrict_7au3e = 0;
		eid_add_String_7au3e = 0;
		eid_addIdentifier_String_7au3e = 0;
		eid_add_Node_7au3e = 0;
		eid_add_Node_Context_7au3e = 0;
		eid_unrollBinaryOperator_Node_int_String_Context_Context_int_int_7au3e = 0;
		eid_isSimpleNumber_String_7au3e = 0;
		eid_getSimpleNumber_String_7au3e = 0;
		eid_isIndirectEval_Node_7au3e = 0;
		eid_addNonEmptyStatement_Node_Context_boolean_7au3e = 0;
		eid_isOneExactlyFunctionOrDo_Node_7au3e = 0;
		eid_addExpr_Node_int_Context_7au3e = 0;
		eid_addList_Node_7au3e = 0;
		eid_addList_Node_boolean_7au3e = 0;
		eid_addList_Node_boolean_Context_7au3e = 0;
		eid_addArrayList_Node_7au3e = 0;
		eid_addCaseBody_Node_7au3e = 0;
		eid_addAllSiblings_Node_7au3e = 0;
		eid_addJsString_Node_7au3e = 0;
		eid_jsString_String_boolean_7au3e = 0;
		eid_regexpEscape_String_CharsetEncoder_7au3e = 0;
		eid_escapeToDoubleQuotedJsString_String_7au3e = 0;
		eid_regexpEscape_String_7au3e = 0;
		eid_strEscape_String_char_String_String_String_CharsetEncoder_boolean_boolean_7au3e = 0;
		eid_identifierEscape_String_7au3e = 0;
		eid_getNonEmptyChildCount_Node_int_7au3e = 0;
		eid_getFirstNonEmptyChild_Node_7au3e = 0;
		eid_getContextForNonEmptyExpression_Context_7au3e = 0;
		eid_getContextForNoInOperator_Context_7au3e = 0;
		eid_appendHexJavaScriptRepresentation_StringBuilder_char_7au3e = 0;
		eid_appendHexJavaScriptRepresentation_int_Appendable_7au3e = 0;
	}
...
private static final String LT_ESCAPED = "\\x3c";
  ...
  void add_7au3e(Node n, Context context) {
...
void add(Node n, Context context) {
	...
	String msig_7au3e = "add(Node$Context)" + eid_add_Node_Context_7au3e;
	try {
		add_7au3e(n, context);
		FieldPrinter.print(this, eid_add_Node_Context_7au3e, c_7au3e,
				msig_7au3e, 1, 5);
		FieldPrinter.print(n, eid_add_Node_Context_7au3e, c_7au3e, msig_7au3e,
				2, 5);
		FieldPrinter.print(context, eid_add_Node_Context_7au3e, c_7au3e,
				msig_7au3e, 3, 5);
	} catch (Throwable t7au3e) {
		FieldPrinter.print(t7au3e, eid_add_Node_Context_7au3e, c_7au3e,
				msig_7au3e, 0, 5);
		throw t7au3e;
	} finally {
		eid_add_Node_Context_7au3e++;
	}
}
}
