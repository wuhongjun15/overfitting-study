...
public class ValueMarker extends Marker {
    ...
    public static int eid_ValueMarker_double_7au3e = 0;
	public static int eid_ValueMarker_double_Paint_Stroke_7au3e = 0;
	public static int eid_ValueMarker_double_Paint_Stroke_Paint_Stroke_float_7au3e = 0;
	public static int eid_getValue_7au3e = 0;
	public static int eid_setValue_double_7au3e = 0;
	...
	public static void clearORefMap() {
		oref_map.clear();
		eid_ValueMarker_double_7au3e = 0;
		eid_ValueMarker_double_Paint_Stroke_7au3e = 0;
		eid_ValueMarker_double_Paint_Stroke_Paint_Stroke_float_7au3e = 0;
		eid_getValue_7au3e = 0;
		eid_setValue_double_7au3e = 0;
     ...
     */
    public void ValueMarker_7au3e(double value, Paint paint, Stroke stroke, 
	...
	public ValueMarker(double value, Paint paint, Stroke stroke,
			Paint outlinePaint, Stroke outlineStroke, float alpha) {
		Object o_7au3e = null;
		String c_7au3e = "org.jfree.chart.plot.ValueMarker";
		String msig_7au3e = "ValueMarker(double$Paint$Stroke$Paint$Stroke$float)"
				+ eid_ValueMarker_double_Paint_Stroke_Paint_Stroke_float_7au3e;
		try {
			ValueMarker_7au3e(value, paint, stroke, outlinePaint,
					outlineStroke, alpha);
			addToORefMap(msig_7au3e, null);
			addToORefMap(msig_7au3e, this);
			addToORefMap(msig_7au3e, null);
			addToORefMap(msig_7au3e, paint);
			addToORefMap(msig_7au3e, stroke);
			addToORefMap(msig_7au3e, outlinePaint);
			addToORefMap(msig_7au3e, outlineStroke);
			addToORefMap(msig_7au3e, null);
